...
if (!require("dbplyr")) install_version("dbplyr", version="2.3.4", repos=CRAN, dependencies=T)
...
if (!require("matrixStats")) install_version("matrixStats", version="1.3.0", repos=CRAN, dependencies=T)
if (!require("openxlsx")) install_version("openxlsx", version="4.2.5.2", repos=CRAN, dependencies=T)
if (!require("patchwork")) install_version("patchwork", version="1.2.0", repos=CRAN, dependencies=T)
...
# packageVersion("BiocFileCache") = 2.8.0
...
# packageVersion("SummarizedExperiment") = 1.30.2
if (!require("TMExplorer")) install("TMExplorer", dependencies=T, update=F)
# packageVersion("TMExplorer") = 0.4.6
