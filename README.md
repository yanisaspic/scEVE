...
___
The repository includes the code of the scEVE algorithm, and the codes used to generate the datasets and the results in the associated paper; "**The differences of results between clustering methods are informative in single-cell RNA-seq ensemble clustering analyses.**" 
