...
This repository includes the code of scEVE, and the code required to generate the results of the related JOBIM2024 paper.
___
...
***Results***
After completing the two steps above, run `paper.R` interactively to reproduce the results of the JOBIM2024 paper:
